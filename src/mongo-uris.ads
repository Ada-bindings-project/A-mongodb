...
package Mongo.URIs is
   ...
   --  function get_read_prefs_t (uri : Uri_T) return access constant libmongoc_1_0_mongoc_mongoc_read_prefs_h.u_mongoc_read_prefs_t;
   --  procedure set_read_prefs_t (uri : In out uri_t; prefs : access constant libmongoc_1_0_mongoc_mongoc_read_prefs_h.u_mongoc_read_prefs_t) ;
   ...
   --  procedure set_write_concern (uri : In out uri_t; wc : access constant libmongoc_1_0_mongoc_mongoc_write_concern_h.u_mongoc_write_concern_t);
